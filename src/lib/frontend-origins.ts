...
// relying solely on FRONTEND_URL being set correctly in the Netlify
// dashboard and a redeploy actually picking it up -- that round trip kept
// silently failing to take effect. This guarantees it works regardless.
